                    ...
                    <form id="cregister-frm" action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" id="middlename" name="middlename" class="form-control form-control-sm form-control-border" placeholder="tên đệm">
                            </div>
                            <div class="form-group col-md-4">
                        ...
                        <div class="row align-item-end">
                            ...
                            <a href="<?= base_url.'./login.php' ?>">Bạn đã có tài khoản ? Đăng nhập</a>
                            </div>
                        <!-- /.col -->
                        </div>
                    </form>
