                ...
                <div class="card-body">
                    <div class="container-fluid">
                        ...
                        <div class="row" id="product_list">
                            ...
                            ?>
                            <div class="col-lg-4 col-md-6 col-sm-12 product-item" style="min-height: 400px">
                                ...
                                <div class="product-img-holder position-relative">
                                    ...
                                    <div class="card-body border-top border-gray">
                                        ...
                                        <div class="d-flex w-100">
                                            <div class="col-auto px-0"><small class="text-muted">nhà xuất bản: </small></div>
                                        ...
                                        <div class="d-flex">
                                            <div class="col-auto px-0"><small class="text-muted">Loại: </small></div>
                            ...
                            <?php else: ?>
                                ...
                                Vui lòng chọn ít nhất 1 danh mục sản phẩm
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
