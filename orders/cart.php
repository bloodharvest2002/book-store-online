            ...
            <div id="cart-list">
                ...
                ?>
                    <div class="col-12 border">
                        <span>Nhà xuất bản: <b><?= $vrow['code']. " - " . $vrow['shop_name'] ?></b></span>
                    </div>
                        ...
                        <div class="d-flex align-items-center border p-2">
                            ...
                            <div class="col-auto flex-shrink-1 flex-grow-1">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="col-auto flex-shrink-1 flex-grow-1">
                                        <button class="btn btn-flat btn-outline-danger btn-sm rem_item"  data-id="<?= $prow['id'] ?>"><i class="fa fa-times"></i> Xoá</button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 border">
                        <div class="d-flex">
                            <div class="col-9 text-right font-weight-bold text-muted">Tất Cả</div>
...
<script>
    $(function(){
        ...
        _conf("Bạn có chắc chắn muốn xoá sản phẩm khỏi danh sách thanh toán ? ",'delete_cart',[$(this).attr('data-id')])
        })
    })
