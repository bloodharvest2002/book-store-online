				...
				<form action="" id="manage-user">	
					...
					<div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="middlename" name="middlename" class="form-control form-control-sm form-control-border" value="<?= isset($middlename) ? $middlename : "" ?>" placeholder="tên đệm">
                        </div>
                        <div class="form-group col-md-4">
                    ...
                    <div class="row">
						...
						<small class="text-muted"><i>Để trống "mật khẩu" nếu bạn không muốn cập nhật nó.</i></small>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="logo" class="control-label">Ảnh</label>
