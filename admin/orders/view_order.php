...
<div class="container-fluid">
	<div class="row">
        ...
        <div class="col-3 border bg-gradient-primary"><span class="">Hình thức thanh toán</span></div>
        <div class="col-9 border"><span class="font-weight-bolder"><?= isset($payment) ? $payment : '' ?></span></div>
...
<script>
    $(function(){
        $('#update_status').click(function(){
            uni_modal("Cập nhật trạng thái đơn hàng - <b><?= isset($code) ? $code : '' ?></b>","orders/update_status.php?id=<?= isset($id) ? $id : '' ?>")
        })
    })
