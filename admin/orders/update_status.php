    ...
    <form action="" id="update_status">
        ...
        <div class="form-group">
            ...
            <select name="status" id="status" class="form-control rounded-0" required>
                <option <?= isset($status) && $status == 0 ? 'selected' : '' ?> value="0">Chưa giải quyết</option>
                ...
                <option <?= isset($status) && $status == 3 ? 'selected' : '' ?> value="3">Đơn hàng đang vận chuyển</option>
                <option <?= isset($status) && $status == 4 ? 'selected' : '' ?> value="4">Đã giao hàng</option>
...
<script>
    $(function(){
        $('#uni_modal #update_status').submit(function(e){
            e.preventDefault();
            var _this = $(this)
            $('.err-msg').remove();
