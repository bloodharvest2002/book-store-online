<h1 class="">Chào Mừng đến với <?php echo $_settings->info('name') ?> - Admin Side</h1>
<style>
  #cover-image{
    width:calc(100%);
    height:50vh;
...
<div class="row">
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Tổng loại nhà xuất bản</span>
        <span class="iinfo-box-number text-right h4">
          <?php 
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Tổng số đơn đặt hàng đang chờ xử lý</span>
        <span class="iinfo-box-number text-right h4">
          <?php 
