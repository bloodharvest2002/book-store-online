                    ...
                    <table class="table table-bordered table-stripped">
                        ...
                        <thead>
                            <tr class="">
                                ...
                                <th class="text-center align-middle py-1">Tham chiếu. Mã số</th>
                                <th class="text-center align-middle py-1">Khách hàng</th>
                                <th class="text-center align-middle py-1">Nhà xuất bản</th>
                                <th class="text-center align-middle py-1">Trạng thái</th>
                                <th class="text-center align-middle py-1">Tổng cộng</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                        ...
                        <tfoot>
                            <tr>
                                <th class="text-center px-1 py-1 align-middel" colspan="6">Tổng cộng</th>
