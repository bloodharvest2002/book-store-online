...
<div class="col-lg-12 py-5">
    <div class="contain-fluid">
        ...
        <h3 class="text-center"><b>Các sản phẩm</b></h3>
        ...
        <div class="row" id="product_list">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 product-item">
                ...
                <div class="product-img-holder position-relative">
                    ...
                    <div class="card-body border-top border-gray" style="min-height: 200px">
                        ...
                        <div class="d-flex">
                            <div class="col-auto px-0"><small class="text-muted">Thể loại: </small></div>
