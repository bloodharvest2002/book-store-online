...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="./login.php" class="h1 text-decoration-none"><b>Khách Hàng</b></a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Đăng nhập đê tiếp tục</p>
      ...
      <form id="cclogin-frm" action="" method="post">
        ...
        <div class="row align-item-end">
          ...
          <a href="<?= base_url.'./register.php' ?>">Tạo tài khoản</a>
          </div>
          <!-- /.col -->
        </div>
      </form>
