        ...
        <div class="col-7 h-100 bg-gradient-light px-4">
            <div class="d-flex justify-content-center align-items-center w-100 h-100">
                <div class="card card-outline card-primary col-12 rounded-0 shadow">
                    ...
                    <a href="./register.php" class="h1"><b>Tạo Tài Khoản</b></a>
                    </div>
                    <div class="card-body">
                    ...
                    <form id="vregister-frm" action="" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="shop_name" class="control-label">Tên nhà xuất bản</label>
                                <input type="text" id="shop_name" autofocus name="shop_name" class="form-control form-control-sm form-control-border" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="shop_owner" class="control-label">Họ Tên Chủ nhà xuất bản</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="shop_type_id" class="control-label">Loại nhà xuất bản</label>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="logo" class="control-label">Logo nhà xuất bản</label>
                        ...
                        <div class="row align-item-end">
                            ...
                            <a href="<?= base_url.'vendor/login.php' ?>">Ban đã có tài khoản ? Đăng nhập</a>
                            </div>
                        <!-- /.col -->
                        </div>
                    </form>
