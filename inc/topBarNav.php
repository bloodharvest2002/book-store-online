      ...
      <nav class="w-100 px-2 py-1 position-fixed top-0 bg-dark text-light" id="login-nav">
        <div class="d-flex justify-content-between w-100">
          ...
          <div>
            ...
            <?php else: ?>
              <a href="./login.php" class="mx-2 text-light text-decoration-none font-weight-bolder">Đăng nhập của khách hàng</a> | 
              <a href="./vendor" class="mx-2 text-light text-decoration-none font-weight-bolder">Đăng nhập nhà xuất bản</a> |
              <a href="./admin" class="mx-2 text-light text-decoration-none font-weight-bolder">Đăng nhập Admin</a>
            <?php endif; ?>
          </div>
        </div>
      </nav>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a href="./?page=products" class="nav-link <?= isset($page) && $page =='products' ? "active" : "" ?>">Các Sản Phẩm</a>
              </li>
              <li class="nav-item">
                <a href="./?page=about" class="nav-link <?= isset($page) && $page =='about' ? "active" : "" ?>">Vê Chúng Tôi</a>
              </li>
              <?php if($_settings->userdata('id') > 0 && $_settings->userdata('login_type') == 3): ?>
              <li class="nav-item">
                <?php 
                ...
                ?>
                <a href="./?page=orders/cart" class="nav-link <?= isset($page) && $page =='orders/cart' ? "active" : "" ?>"><span class="badge badge-secondary rounded-cirlce"><?= format_num($cart_count) ?></span> Thanh Toán</a>
              </li>
              <li class="nav-item">
